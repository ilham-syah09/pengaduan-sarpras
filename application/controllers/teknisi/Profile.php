...
class Profile extends CI_Controller
{
    ...
    public function updateProfile()
    {
        ...
        if ($foto) {
            ...
            if (!$this->upload->do_upload('foto')) {
                ...
                redirect('teknisi/profile', 'refresh');
            } else {
                ...
                if ($update) {
                    ...
                    $this->session->set_flashdata('toastr-success', 'Success update!');

                    redirect('teknisi/profile', 'refresh');
                } else {
                    $this->session->set_flashdata('toastr-error', 'Failed update!');
                    redirect('teknisi/profile', 'refresh');
                }
            }
        }
    ...
    public function changePassword()
    {
        ...
        if (password_verify('user123', $hash)) {
            ...
            $this->session->set_flashdata('toastr-error', 'Failed update! Wrong current password!');
            redirect('teknisi/profile', 'refresh');
        }
    }
}
